...
class StandardPrinterService implements PrinterService {
  ...
  Future<void> printEscPos(List<int> bytes) async {
    ...
    throw UnimplementedError("ESC/POS raw printing not supported by StandardPrinterService.");
  }
...
class NetworkThermalPrinterService implements PrinterService {
  ...
  @override
  Future<void> printPdf(Uint8List pdfBytes) async {
    throw UnimplementedError("Thermal printers do not natively support PDF bytes. Convert to image first.");
  }

  @override
  Future<void> printEscPos(List<int> bytes) async {
    // Mock sending bytes via socket
    print("Sending ${bytes.length} bytes to thermal printer...");
  }
  ...
  Future<void> showPrintPreview(Uint8List pdfBytes, String documentName) async {
    ...
    throw UnimplementedError("Preview not supported for ESC/POS mode directly.");
  }
}
