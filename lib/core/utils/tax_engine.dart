...
class TaxEngine {
  ...
  static double calculateTax(double amount, double rate, {bool isInclusive = false}) {
  ...
  static double calculateBaseAmount(double amount, double rate, {bool isInclusive = false}) {
